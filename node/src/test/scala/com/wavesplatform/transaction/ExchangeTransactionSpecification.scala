...
class ExchangeTransactionSpecification extends PropSpec with PropertyChecks with Matchers with TransactionGen with NTPTime {
  ...
  property("JSON format validation V2") {
    ...
    val buy = OrderV2(
<<<<<<< HEAD:src/test/scala/com/wavesplatform/transaction/ExchangeTransactionSpecification.scala
...
>>>>>>> d1f0230aa355768b58cb3d04cd79b50022bfdc90:node/src/test/scala/com/wavesplatform/transaction/ExchangeTransactionSpecification.scala
      OrderType.BUY,
      2,
      6000000000L,
      1526992336241L,
